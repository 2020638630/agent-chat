你是本机工程代理。在 Windows 上落地「微信风格多角色社交聊天」MVP。
...
6\. UI 中文；布局必须是微信 PC 三栏，不是手机单栏，也不是管理后台
...
用浏览器打开看：三栏微信 PC 布局、配色、单聊/群聊/朋友圈/通讯录/主页。
...
最左深色导航（聊天/通讯录/朋友圈）+ 中栏会话列表 + 右侧主区

主色 #07C160，自己气泡 #95EC69，对方白气泡，聊天背景 #EDEDED，导航 #1E1E1E

第一期：私聊文字、群聊（带角色名和@）、通讯录、角色主页、朋友圈最小版
...
阶段 A（必须完成）：建目录、健康检查、微信三栏空壳、README。
...
阶段 D（有时间再做）：朋友圈时间线 +「让 TA 发一条」。做不完就留页面和接口。
...
登录注册、语音/TTS、朋友圈定时、完整世界书引擎、移动端、暗色完整版、CI 部署、自动 push。
